...
double getZs(rvec *coor,matrix box,double binSize,int natoms,int natomPmol,char xyz){
	...
	if( comZ - box[alpha][alpha]/2.0 > binSize ){
		...
		for(i=1;i< box[alpha][alpha]/2.0/binSize*2.0 ; i++){
			zs = i*binSize/2.0 + dz; 
			tmp1 = 0.0;
